...
class Model_barang extends CI_Model{
 	...
 	public function update_counter($id_brg)
    {
		...
		$id_brg 	= $this->db->where('id_brg',$id_brg)->get('tb_barang');
		$id_user 	= $this->db->where('id',$id)->get('tb_user');
		$event		= $this->db->where('visit',@$visit)->get('tb_barang');
		...
		//$this->db->insert('tb_tracker', $data);
		return true;
    }
